...
2. **一手标准定事实**——协议字段、状态机、术语以 RFC / IEEE 标准原文为准。制作期对 16 处教材引用做过对照官方目录的审计（见 [CHANGELOG.md](../CHANGELOG.md) 0.5 条目）；本清单编制时，全部课时的章节引用又对照官方 8E 目录逐条复核，修正了 7 处编号偏差（明细记录于 CHANGELOG）；两轮全课程审查均设"协议标准与 RFC 一致性"维度；
...
| 证据 | 位置 | 说明 |
|---|---|---|
| 全书引用审计 | [CHANGELOG.md](../CHANGELOG.md) 0.5 条目 | 制作期将 16 处教材引用点逐一对照 Kurose 8E 官方目录核对一致 |
